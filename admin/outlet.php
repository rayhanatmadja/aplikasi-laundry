...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Daftar Data Outlet</h4>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a href="outlet_hapus.php?id=<?= htmlspecialchars($outlet['id_outlet']); ?>" onclick="return confirm('Yakin menghapus outlet ? ');" data-toggle="tooltip" data-placement="bottom" title="Hapus" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
