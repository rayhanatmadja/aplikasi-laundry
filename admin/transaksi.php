                        ...
                        <tbody>
                            <?php foreach ($data as $transaksi) : ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="transaksi_detail.php?id=<?= $transaksi['id_transaksi']; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success btn-block">Detail/Edit</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
